...
class TextSolver():
    ...
    def get_newnode(self, text_id):
        ...
        """
        new_node = {"node_type": 0, "id": text_id, "level": 1, "children": []}
        return new_node
...
class TitleSolver():
    ...
    def get_newnode(self, title_id, title_text):
        ...
        """
        new_node = {"node_type": 1, "id": title_id, "text": title_text, "children": []}
        return new_node
...
class ListSolver():
    ...
    def get_newnode(self, list_id):
        ...
        """
        new_node = {"node_type": 2, "id": list_id, "children": []}
        return new_node
...
class TableSolver():
    ...
    def get_newnode(self, table_id):
        ...
        """
        new_node = {"node_type": 3, "id": table_id, "children": []}
        return new_node
...
class FigureSolver():
    ...
    def get_newnode(self, figure_id):
        ...
        """
        new_node = {"node_type": 4, "id": figure_id, "children": []}
        return new_node
